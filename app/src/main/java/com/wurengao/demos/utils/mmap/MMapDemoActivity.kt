package com.wurengao.demos.utils.mmap
...
import com.wurengao.demos.jni.NativeUtils.nativeReadFromMMap
import com.wurengao.demos.jni.NativeUtils.nativeWriteToMMap
...
class MMapDemoActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val MMAP_PATH = "/sdcard/Android/data/com.wurengao.demos/files/cache/mmap"
    }
